...
.nav-bar
  ...
  .tab(@click="$router.push('/upgrade')")
    .o-icon-wrapper(:class="{ active: route.path === '/upgrade' }")
      o-icon(pack="mdi" icon="arrow-up-bold-hexagon-outline" size="medium")
  .tab(@click="$router.push('/friends')")
    .o-icon-wrapper(:class="{ active: route.path === '/friends' }")
